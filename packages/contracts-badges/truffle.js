...
const kovanProvider = process.env.SOLIDITY_COVERAGE ? undefined : createProvider('kovan');
const rinkebyProvider = process.env.SOLIDITY_COVERAGE ? undefined : createProvider('rinkeby');
const mainnetProvider = process.env.SOLIDITY_COVERAGE ? undefined : createProvider('mainnet');
const ropstenProvider = process.env.SOLIDITY_COVERAGE ? undefined : createProvider('ropsten');
